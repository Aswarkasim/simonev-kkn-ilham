                    ...
                    <div class="col-md-12">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="" class="pull-right">Nama Laporan</label>
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" name="nama_laporan" required value="<?= isset($laporan) ? $laporan->nama_laporan : set_value('nama_laporan') ?>" placeholder="Nama Laporan" class="form-control">
                                    </div>
                                </div>
                            </div>
