            ...
            <form action="" method="post">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="judul_berita" value="<?= $berita->judul_berita ?>" required placeholder="Judul Berita" class="form-control">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <textarea name="isi" id="editor1" required placeholder="Isi Berita" class="form-control"><?= $berita->isi; ?></textarea>
                  </div>
                </div>
              </div>
